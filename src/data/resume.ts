...
export const DATA = {
    ...
    projects: [
        ...
        },
        {
            ...
            dates: "2024",
            active: true,
            description: "Dummy Project. A comprehensive conversational AI system built with natural language processing models. Handles intent classification, entity extraction, and maintains context across multi-turn exchanges.",
            technologies: ["NodeJS", "Python", "LLMs"],
            links: [],
            image: "",
            video: "",
        },
        {
            ...
            dates: "2023",
            active: true,
            description: "Dummy Project. Command line interface for deploying scalable cloud resources using infrastructure as code. Interacts cleanly with AWS/GCP APIs to provision instances securely.",
        ...
        },
        {
            ...
            dates: "2022",
            active: true,
            description: "Dummy Project. Real-time metrics dashboard connecting to streaming data sources. Visualizes high-frequency updates with WebGL-accelerated charting components.",
            technologies: ["React", "WebGL", "Kafka"],
            links: [],
            image: "",
            video: "",
        }
